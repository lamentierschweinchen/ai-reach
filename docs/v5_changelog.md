...
- **Known data limitations:** the 1950 outlier, the 1991–2025 breaks and the constant post-2025 workforce are documented in the methodology's known limitations. Annual records, scores and weights were not smoothed or rescored. These estimates are unsuitable for interpreting individual annual jumps as measured job losses; repairing the series remains v6 work.
