...
- **Share images:** the homepage link preview was a capture from before v5 (57% average, 3.4B workers). It now shows the 2026 view (34%, 3.6B) and its alt text names 2026. The generic Mirror card carries the current project name. Image URLs are versioned so cached previews refresh.
