...
- **Known data limitations at the point of use:** timeline notes flag the 1950 outlier, the 1991–2025 breaks and the constant post-2025 workforce. Annual records, scores and weights were not smoothed or rescored. These estimates are unsuitable for interpreting individual annual jumps as measured job losses; repairing the series remains v6 work.
...
- **Essay:** following the owner's clarification that the dek describes a conceptual contrast between knowledge and physical work, the dek now says machines are moving toward mastery of knowledge work while much physical work still escapes them. The body identifies estimated time weights and describes the roughly sixty-point, consistently workforce-weighted gap as a consequence of model assumptions. Source and local generated editions were rebuilt.
- **Deep-link edge cases:** overlong queries are no longer truncated into a different valid OG name. Unresolved client links explicitly identify Nurse as an example, and choosing a result preserves unrelated query parameters and the fragment. The search popup now sits above the scroll hint.
