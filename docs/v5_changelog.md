...
- **Known breaks in the workforce-share series, now visible.** With the homepage reading 1991–2025 for the first time, the annual series shows classification breaks — the largest at 2010→2011 (Land & Sea −7.0 points, about 202M workers; Maintaining & Fixing +4.8), with roughly ±2-point year-to-year noise afterwards — and the 1950 cross-section is an outlier (Land & Sea 25% between 54% and 48%). These are artefacts of data assembly, not events; they are disclosed in the methodology's limitations and queued for v6. The 2025 shares that weight the headline figures come from the post-2011 regime.
